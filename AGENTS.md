...
- Repository maintenance: `.claude/personas/maintainer.md`
- Environment setup, deployment, or demo operation: `.claude/personas/operator.md`
- Loan origination domain, architecture, controls, or value-story changes: `.claude/personas/use-case-creator.md`
