...
2. **MT-072 — no loan screens are captured.** The screenshot inventory is empty by design;
   the gallery and marketecture builders render "Screen capture pending" placeholders.
