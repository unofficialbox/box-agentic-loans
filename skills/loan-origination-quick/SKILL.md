...
| Covenant precedent | Fetch the two prior-loan packages for LN-2023-0311 and LN-2025-0148 **in parallel** (independent reads; issue both `getLoanPackage` calls together) → `ai_qa_multi_file` across the two executed agreements and the 2026 markup. Expected: 70% LTV and 1.30x DSCR tested quarterly, Section 8 and Schedule 1, signed by Jordan Pike and Priya Shah; the 2026 markup asks 1.10x annually. One table, then preview the 2025 agreement at Schedule 1. Do not answer with `extractLoanTerms`. |
