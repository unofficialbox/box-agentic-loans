...
Colours are the portal tokens only: `#0A332E` (ground), `#0F4C45` (mark), `#C9871A` (amber). Upload the PNG as-is; Slack applies its own corner rounding, and the mark clears the corner radius with room to spare.
