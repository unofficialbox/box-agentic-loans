#!/usr/bin/env python3
"""Build portable, self-contained HTML guides for LOS setup and the loan origination scenario."""
...
SCENARIOS = (
    {"order": "00", "slug": "operator-setup", "source": ROOT / "docs" / "SETUP.md",
     "accent": "#f4c86a", "accent_2": "#5a95ff", "label": "Prepare the confirmed demo environment", "brands": ("box", "salesforce")},
    {"order": "01", "slug": "box-salesforce-los", "source": ROOT / "DEMO-CLICKPATH.md",
     "accent": "#a98bff", "accent_2": "#5aaeff", "label": "The canonical loan origination clickpath", "brands": ("box", "salesforce")},
    {"order": "02", "slug": "rehearsal", "source": ROOT / "docs" / "PRESENTING.md",
     "accent": "#a98bff", "accent_2": "#5aaeff", "label": "Stage, rehearsal and reset", "brands": ("box", "salesforce")},
)
...
def stylesheet(accent: str, accent_2: str) -> str:
    ...
    * {{ box-sizing: border-box; }}
    ...
    @media (max-width: 620px) {{
      ...
      .brand-label::after {{ content: "Acme LOS Guide"; font-size: .88rem; }}
...
<head>
  ...
  <title>Acme LOS · {html.escape(rendered.title)} Demo Guide</title>
  <style>{stylesheet(str(scenario['accent']), str(scenario['accent_2']))}</style>
</head>
<body>
  <header class="masthead">
    <div class="shell masthead-inner">
      <div class="brand"><img data-brand-logo="box" src="{data_uri(BRAND_ASSETS / 'box-logo-blue.svg')}" alt="Box"><span class="brand-label">Acme Bank · LOS Demo Guide</span></div>
